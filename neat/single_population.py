...
class Population:
    ...
    def __create_population(self):
        ...
        self.__population = [genotypes(config.Config.input_nodes, config.Config.output_nodes) \
    ...
    def epoch(self, n, stats=True, save_best=False):
        ...
        for generation in range(n):
            ...
            survivors = int(round(self.__popsize*config.Config.survival_threshold)) 
...
#                offspring.append(child)
            ...
            while (len(offspring) < config.Config.pop_size  - survivors):
